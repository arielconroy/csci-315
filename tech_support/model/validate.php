...
class Validate {
    ...
    public function text($name, $value, $required = true, $min = 1, $max = 51) {
    ...
    public function password($name, $value, $required = true, $min = 6, $max = 21) {
    ...
    public function zip($name, $value, $required = true, $min = 1, $max = 21) {
